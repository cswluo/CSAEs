function [net,info] = cnn_trainval(net, xtrain, ytrain, xval, yval, varargin)
...
for epoch=1:opts.numEpochs
  ...
  modelPath = fullfile(opts.expDir, 'net-pre-trainval-epoch-%d.mat') ;
  modelFigPath = fullfile(opts.expDir, 'net-pre-trainval.pdf') ;
  if opts.continue
